...
import 'package:api_test_app/presentation/pages/mixed_api/state_logic/mixed_api_page_state.dart';
import 'package:http/http.dart' as http;
import 'package:flutter_riverpod/flutter_riverpod.dart';

class MixedApiPageNotifier extends StateNotifier<MixedApiPageState> {
  final StateNotifierProviderRef<MixedApiPageNotifier, MixedApiPageState> ref;
  MixedApiPageNotifier({required this.ref}) : super(MixedApiPageState());
...
final mixedApiPageProvider =
    StateNotifierProvider<MixedApiPageNotifier, MixedApiPageState>((ref) {
  return MixedApiPageNotifier(ref: ref);
});
